...
const createQuestionsSlice = (set, get) => ({
  ...
  fetchQuestions: async () => {
    ...
    try {
      ...
      logger.error('fetchQuestions failed:', error);
      toast.error('fetchQuestions: ' + (error.message || 'Unknown error'));
  ...
  updateProgress: async (questionId, updates) => {
    ...
    try {
      ...
      logger.error('updateProgress failed:', error);
      toast.error('updateProgress: ' + (error.message || 'Unknown error'));
  ...
  openFlashcards: async () => {
    try {
      ...
      logger.error('openFlashcards failed:', error);
      toast.error('openFlashcards: ' + (error.message || 'Unknown error'));
      return [];
    }
  },
  ...
  bulkUpdateProgress: async (updates = []) => {
    ...
    try {
      ...
      logger.error('bulkUpdateProgress failed:', error);
      toast.error('bulkUpdateProgress: ' + (error.message || 'Unknown error'));
      throw error;
    }
  },
});
...
const createStatsSlice = (set) => ({
  ...
  fetchLightStats: async () => {
    try {
      ...
      logger.error('fetchLightStats failed:', error);
      toast.error('fetchLightStats: ' + (error.message || 'Unknown error'));
    }
  },
  ...
  fetchStats: async () => {
    try {
      ...
      logger.error('fetchStats failed:', error);
      toast.error('fetchStats: ' + (error.message || 'Unknown error'));
    }
  },
});
...
const createUtilitiesSlice = (set, get) => ({
  ...
  fetchUtilities: async () => {
    try {
      ...
      logger.error('fetchUtilities failed:', error);
      toast.error('fetchUtilities: ' + (error.message || 'Unknown error'));
    }
  },
  ...
  fetchSettings: async () => {
    try {
      ...
      logger.error('fetchSettings failed:', error);
      toast.error('fetchSettings: ' + (error.message || 'Unknown error'));
    }
  },

  updateSettings: async (updates, get) => {
    try {
      ...
      toast.error('updateSettings: ' + (error.message || 'Unknown error'));
    }
  },
});
